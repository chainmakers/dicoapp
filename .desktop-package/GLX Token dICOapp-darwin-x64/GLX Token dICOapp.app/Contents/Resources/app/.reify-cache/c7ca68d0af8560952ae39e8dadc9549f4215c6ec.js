"use strict";var module1=module;module1.export({default:()=>DesktopPathResolver});var path,join;module1.watch(require('path'),{default(v){path=v},join(v){join=v}},0);var fs;module1.watch(require('fs'),{default(v){fs=v}},1);

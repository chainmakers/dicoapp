"use strict";var module1=module;module1.export({default:()=>LocalServer});var http;module1.watch(require('http'),{default(v){http=v}},0);var connect;module1.watch(require('connect'),{default(v){connect=v}},1);var findPort;module1.watch(require('find-port'),{default(v){findPort=v}},2);var enableDestroy;module1.watch(require('server-destroy'),{default(v){enableDestroy=v}},3);var url;module1.watch(require('url'),{default(v){url=v}},4);var path;module1.watch(require('path'),{default(v){path=v}},5);var fs;module1.watch(require('fs-plus'),{default(v){fs=v}},6);var send;module1.watch(require('send'),{default(v){send=v}},7);

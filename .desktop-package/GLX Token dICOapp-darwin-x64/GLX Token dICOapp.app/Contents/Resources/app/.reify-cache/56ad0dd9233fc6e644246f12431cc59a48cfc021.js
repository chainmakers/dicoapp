"use strict";module.export({default:()=>LoggerManager});var join;module.watch(require('path'),{join(v){join=v}},0);var winston;module.watch(require('winston'),{default(v){winston=v}},1);

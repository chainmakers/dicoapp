"use strict";var module1=module;var electron;module1.watch(require('electron'),{default(v){electron=v}},0);var Events;module1.watch(require('events'),{EventEmitter(v){Events=v}},1);var path;module1.watch(require('path'),{default(v){path=v}},2);var fs;module1.watch(require('fs-plus'),{default(v){fs=v}},3);var shell;module1.watch(require('shelljs'),{default(v){shell=v}},4);var assignIn;module1.watch(require('lodash/assignIn'),{default(v){assignIn=v}},5);var Module;module1.watch(require('./modules/module'),{default(v){Module=v}},6);var LoggerManager;module1.watch(require('./loggerManager'),{default(v){LoggerManager=v}},7);var DesktopPathResolver;module1.watch(require('./desktopPathResolver'),{default(v){DesktopPathResolver=v}},8);var WindowSettings;module1.watch(require('./windowSettings'),{default(v){WindowSettings=v}},9);var Squirrel;module1.watch(require('./squirrel'),{default(v){Squirrel=v}},10);/* eslint-disable import/no-unresolved */

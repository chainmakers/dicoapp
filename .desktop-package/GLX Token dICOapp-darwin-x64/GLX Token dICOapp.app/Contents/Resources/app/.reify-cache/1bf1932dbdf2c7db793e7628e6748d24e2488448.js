"use strict";module.export({default:()=>LocalStorage});var shelljs;module.watch(require('shelljs'),{default(v){shelljs=v}},0);var app;module.watch(require('electron'),{app(v){app=v}},1);var fs;module.watch(require('fs-plus'),{default(v){fs=v}},2);var path;module.watch(require('path'),{default(v){path=v}},3);

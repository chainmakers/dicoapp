"use strict";module.export({default:()=>WindowSettings});var join;module.watch(require('path'),{join(v){join=v}},0);var assignIn;module.watch(require('lodash/assignIn'),{default(v){assignIn=v}},1);/* eslint-disable no-param-reassign */

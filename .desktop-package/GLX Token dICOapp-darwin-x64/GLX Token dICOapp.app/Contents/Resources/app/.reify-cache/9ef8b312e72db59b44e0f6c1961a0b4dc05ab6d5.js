"use strict";module.export({default:()=>Squirrel});var path;module.watch(require('path'),{default(v){path=v}},0);var spawnSync;module.watch(require('child_process'),{spawnSync(v){spawnSync=v}},1);var fs;module.watch(require('fs-plus'),{default(v){fs=v}},2);var os;module.watch(require('os'),{default(v){os=v}},3);var electron;module.watch(require('electron'),{default(v){electron=v}},4);/* eslint-disable import/no-dynamic-require */
